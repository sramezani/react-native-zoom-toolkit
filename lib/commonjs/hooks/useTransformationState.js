...
const useTransformationState = param => {
  const containerSize = (0, _useSizeVector.useSizeVector)(0, 0);
  const childSize = (0, _useSizeVector.useSizeVector)(0, 0);
  const maxScale = (0, _reactNativeReanimated.useSharedValue)(1);
  const translate = (0, _useVector.useVector)(0, 0);
  const scale = (0, _reactNativeReanimated.useSharedValue)(1);
  const position = (0, _useVector.useVector)(initialPosition, initialPosition);
